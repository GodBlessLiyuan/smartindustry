...
public class BusinessUtil {
    ...
    public void recommend(List<PickHeadPO> pos, boolean flag,PickBodyMapper pickBodyMapper,PickHeadMapper pickHeadMapper,StorageLabelMapper storageLabelMapper,LabelRecommendMapper labelRecommendMapper) {
        ...
        for (PickHeadPO po : pos) {
            ...
            for (PickBodyBO bo : bodyBOs) {
                List<StorageLabelBO> storageLabelBOS;
                if (flag) {
